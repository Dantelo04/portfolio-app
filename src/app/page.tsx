  ...
  const jobs = [
    {
      id: 1,
      title: "OneHQ",
      description: "Full-time Front End Developer",
      logo: "/onehqlogo.png",
    ...
    },
    {
      id: 2,
      title: "Definetec",
      description: "Fullstack Odoo Developer",
      logo: "/definetec.png",
    ...
    },
    {
      id: 3,
      title: "CPB",
      description: "Blockchain D-App Developer",
      logo: "",
    ...
    <div className="flex flex-col xl:space-y-4 items-center w-auto min-h-screen max-w-screen">
      <div className="flex flex-col min-[1700px]:w-8/12 w-11/12 items-center justify-center space-y-4 xl:items-start h-fit pt-20">
        <div className="flex xl:flex-row flex-col xl:space-x-4 space-y-4 xl:space-y-0 xl:h-72 xl:items-start items-center w-full">
              ...
              <div className="flex min-[800px]:flex-row flex-col space-y-5 min-[800px]:space-x-6 p-5 items-center max-w-full min-[800px]:justify-start justify-center w-full">
                ...
                <div className="flex flex-col xl:h-64 text-start w-full justify-center space-y-2 rounded">
                  ...
                  <div className="flex flex-col gap-4 text-neutral-400 ">
                    <div className="">
                      I am a {expertise.toLowerCase()} based in Paraguay with{" "}
          ...
          <div className="xl:flex flex-col space-y-4 xl:w-full w-full grow h-full overflow-hidden">
              ...
              <div className="flex justify-center p-2 w-full text-neutral-500">
                <div className="wrapper">
                  <div className="marquee">
                    <p>
                      Latest <span className="text-neutral-100">work</span> ✦
                      Latest <span className="text-neutral-100">work</span> ✦
                      Latest <span className="text-neutral-100">work</span> ✦
                      Latest <span className="text-neutral-100">work</span> ✦
                      Latest <span className="text-neutral-100">work</span> ✦
            ...
            <div className="flex xl:flex-row flex-col xl:space-y-0 space-y-4 xl:space-x-4 w-auto h-full">
              <Card
                className="xl:min-h-32 xl:grow flex-grow h-full"
                href="https://github.com/Dantelo04"
                newTab
              >
                <div className="flex flex-row space-x-2 p-5 text-neutral-700 w-full items-end h-full">
                  ...
                  <div className="flex items-end">
                    <Link
                      href="#"
                      className="hover:text-neutral-100 duration-150 ease-in"
                    >
                      <CgArrowRight className="w-5 h-5"></CgArrowRight>
                    </Link>
                  </div>
                </div>
              </Card>
              <Card
                href="https://www.linkedin.com/in/dante-rivarola-dinatale-264a82289/"
                newTab
                className="xl:grow"
              >
                <div className="flex flex-row space-x-2 p-5 text-neutral-700 w-full items-end h-full">
        ...
        <div className="flex xl:flex-row flex-col gap-4 w-full grow xl:h-full">
          <Card
            className="xl:grow xl:w-fit w-full bg-gradient-to-tl relative border-gray-950"
            color="to-blue-950 relative-card from-blue-600"
            href="https://www.linkedin.com/company/onehq/posts/?feedView=all"
            newTab={true}
          >
            <div className="flex xl:flex-row flex-col space-y-5 xl:space-x-6 xl:space-y-0 p-5 items-center max-w-full xl:justify-center xl:h-64 justify-center w-full">
              <div className="xl:flex flex-col hidden w-full text-start justify-center px-1 xl:space-y-2 space-y-2 rounded max-w-full">
                ...
                <div className="text-white">
                  full-time <strong> {currentCharge.toLowerCase()}</strong>
                </div>
                <div className="inline-flex gap-2 py-2 items-center justify-start text-white w-full">
                  <FaReact
                    className="w-10 h-10 z-50 cursor-pointer"
                    title="React.Js"
                  />
                  <SiTypescript
                    className="w-10 h-10 z-50 cursor-pointer"
          ...
          <Card
            ...
            className="xl:grow xl:w-fit w-full bg-gradient-to-tl relative-card border-gray-800 border-0"
            ...
            <div className="flex xl:flex-row flex-col space-y-5 xl:space-x-6 xl:space-y-0 p-5 items-center max-w-full xl:justify-center xl:h-64 justify-center w-full">
              <div className="xl:flex flex-col hidden w-full text-start justify-center px-1 xl:space-y-2 space-y-2 rounded max-w-full">
                ...
                <div className="text-neutral-100/50">
                  <strong>software engineering</strong> student
                </div>
          ...
          <XpCard className="w-full" title="Proyects">
            <div className="border w-full grid xl:grid-cols-4 grid-cols-1 gap-3">
              <Project
                title="Bloguealo"
                src="/bloguealo.png"
                href="https://bloguealo.vercel.app/"
                description="Bloguealo is a blog website made with NextJS, mongodb, tailwind css, typescript and aws s3."
              >
                <SiNextdotjs className="w-10 h-10" />
                <SiTypescript className="w-9 h-9" />
                <SiMongodb className="w-10 h-10" />
                <SiAmazonwebservices className="w-10 h-10" />
                <RiTailwindCssFill className="w-10 h-10" />
              </Project>
              <Project
              ...
              <Project
                ...
                src="/todo.png"
                href="https://mynewtodoapp-46e40.web.app/"
              ...
              <a
                href={"https://github.com/Dantelo04"}
                target="_blank"
                className="text-neutral-400 w-full min-h-32 rounded p-10 bg-white border-neutral-400 font-mono flex flex-col justify-center items-center gap-5"
              >
                <FaGithub className="w-20 h-20 text-neutral-400" />
                <div className="text-xl inline-flex gap-2 justify-center items-center">
                  See more
        ...
        <div className="flex xl:flex-row flex-col space-y-4 xl:space-y-0 w-full xl:space-x-4 xl:h-72">
          ...
          <Card
            href="/contact"
            className="h-60 xl:h-full xl:aspect-square grow relative"
          >
            <div className="flex flex-row space-x-2 p-4 w-full items-center">
              {jobs.map((job) => (
                <div
                  key={job.id}
                  className="border bg-neutral-800/90 border-neutral-700 h-full rounded-md flex flex-col items-center p-3 w-full"
                >
                  <h3 className="w-full text-start text-xl font-bold">
                    {job.title}
                  </h3>
                  <div className="w-full bg-neutral-700 h-[1px] mb-1.5"></div>
                  <div className="w-full">
                    <Tag>{job.time}</Tag>
                  </div>
                </div>
        ...
        <div className="flex xl:flex-row flex-col space-y-4 xl:space-y-0 w-full xl:space-x-4 xl:h-60">
          <Card
            href="/contact"
            className="h-60 xl:h-full xl:aspect-square grow relative"
          >
            <div className="flex flex-row space-x-2 p-4 xl:p-8 justify-between relative w-full items-center">
              <div className="flex font-bold gap-4 text-4xl xl:text-6xl tracking-tighter">
                LETS WORK TOGETHER
              </div>
              <div className="flex flex-col justify-center items-center gap-2 text-5xl">
                <CgArrowRight className="w-12 h-12"></CgArrowRight>
              </div>
            </div>
          </Card>
        </div>
