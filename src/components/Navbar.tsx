...
export default function Navbar(){
    ...
    return(
        <div className={isOpen ? "flex xl:flex-row flex-col xl:bg-black/0 bg-black/35 xl:space-y-0 space-y-5 fixed justify-between items-center h-auto xl:p-5 xl:py-5 xl:px-4 top-0 xl:w-full w-full z-50 duration-100 transition-all min-[1700px]:backdrop-blur-none backdrop-blur-lg" : "flex xl:flex-row flex-col xl:space-y-0 space-y-7 fixed items-center transition-all h-screen xl:p-5 py-5 px-4 top-0 xl:w-9/12 w-full z-40 justify-start backdrop-blur-xl xl:bg-black/50 duration-100"}>
